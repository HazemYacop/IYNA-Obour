  ...
  <div class="page-wrapper">
    <header id="site-header">
      ...
      <nav class="site-navigation" data-aos="fade-down" data-aos-duration="1000">
        <div class="nav-brand">
          <a href="index.php"><img src="./assets/IYNA-logo.png" alt="IYNA Obour Chapter Logo"></a>
        </div>
        ...
        <div class="nav-links" id="nav-links">
          ...
          <ul class="nav-list" id="main-nav-list">
            <li class="nav-item dropdown" id="nav-about">
              ...
              <ul class="dropdown-menu" id="about-sub">
                <li><a href="#vision-section">Vision &amp; Mission</a></li>
                <li><a href="#team-section">Our Team</a></li>
              </ul>
            </li>
            <li class="nav-item dropdown" id="nav-research">
              <a style="cursor: pointer;">
                Research
                <i class="fa-solid fa-angle-down dropdown-arrow"></i>
              </a>
              <ul class="dropdown-menu" id="research-sub">
                <li><a href="./magazines.html">Magazines</a></li>
                <li><a href="./papers.html">Papers</a></li>
              </ul>
            </li>
            <li class="nav-item dropdown" id="nav-competitions">
              <a href="./competitions.html">
                Competitions
                <i class="fa-solid fa-angle-down dropdown-arrow"></i>
              </a>
              <ul class="dropdown-menu" id="competitions-sub">
      ...
      <section class="hero-banner" data-aos="fade-up" data-aos-duration="1000">
        ...
        <div class="hero-cta">
          <a href="https://forms.gle/7FSm3cXsrBtWiU927" target="_blank">
    ...
    <main id="main-content">
            ...
            <div class="team-member-card">
              ...
              <div class="member-info">
                ...
                <div class="member-socials">
                  ...
                  <a class="member-info-trigger"
                     onclick="openModal('Habiba Roushdy','Vice Presedent','The Vice President of IYNA Obour, she is dedicated to make a positive impact in life. Always love to explore new experiences passionate about neuroscience and aspires to be well-versed in it.','./assets/habiba-roushdy.png')">
                    <i class="fa-solid fa-circle-info"></i>
                  </a>
                </div>
              </div>
            ...
            <div class="team-member-card">
              ...
              <div class="member-info">
                ...
                <div class="member-socials">
                  ...
                  <a class="member-info-trigger"
                     onclick="openModal('Kenzy Hesham','Vice Presedent','Vice President of IYNA Obour Chapter, passionately exploring neuroscience. Creating a collaborative environment where members can share ideas and learn together.','./assets/kenzy-hesham.png')">
                    <i class="fa-solid fa-circle-info"></i>
                  </a>
                </div>
              </div>
            ...
            <div class="team-member-card">
              ...
              <div class="member-info">
                ...
                <div class="member-socials">
                  ...
                  <a class="member-info-trigger"
                     onclick="openModal('Ans Abdeltawab','Head Graphic Design','Passionate about medical engineering, digital art, and graphic design. Over 11 clubs experience in design, focusing on innovation and creativity.','./assets/ans-abdeltawab.png')">
                    <i class="fa-solid fa-circle-info"></i>
                  </a>
                </div>
              </div>
      ...
      <section class="fade-section" id="contact-section" data-aos="fade-up" data-aos-duration="1000">
        <img src="./assets/contact-us-image.png" alt="IYNA Obour - Contact Us" id="contact-us-image">
        <div id="form-section">
          <div class="contact-intro">
            <h2 class="contact-title">Contact Us</h2>
            <h3 class="contact-subtitle">Send us a message, we will get back to you</h3>
          </div>
          <form action="process-contact.php" method="POST" class="contact-form" id="contact-form">
      ...
      <section class="fade-section" id="newsletter-section" data-aos="fade-up" data-aos-duration="1000">
        ...
        <div class="newsletter-form-container">
          <form action="process-newsletter.php" method="POST" class="newsletter-form" id="newsletter-form">
            <input type="email" placeholder="Email Address" class="newsletter-email" id="newsletter-email" name="newsletter-email" required>
    ...
    <footer class="site-footer">
      <div class="footer-links">
        ...
        <div class="footer-column">
          <h3>Competitions</h3>
          <ul>
            <li><a href="./competitions.html">Competition 1</a></li>
        ...
        <div class="footer-column">
          <h3>Programs</h3>
          <ul>
            <li><a href="./programs.html">Program 1</a></li>
            <li><a >Coming soon ...</a></li>
          </ul>
        </div>
        <div class="footer-column">
          <h3>Events</h3>
          <ul>
            <li><a href="./events.html">Event 1</a></li>
            <li><a >Coming soon ...</a></li>
          </ul>
        </div>
        <div class="footer-column">
